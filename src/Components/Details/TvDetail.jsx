      ...
      <div className="h-fit lg:px-6 py-1 flex justify-between lg:items-start md:items-center sm:items-center items-center sm:flex-col flex-col md:flex-col lg:flex-row md:gap-4 sm:gap-4 gap-4 lg:gap-0">
        ...
        <div className="lg:w-[20%] w-[90%] h-[100%]  bg-zinc-600/40 p-5 hover:scale-102 hover:border-r-5 border-[#6556cd] justify-center flex flex-col gap-2 rounded-md">
            ...
            <h1 className="flex">
                ...
                <p className="font-regular pl-2">{info.details.type }</p>
            </h1>
            <h1 className="flex">
            ...
            <h1 className="flex">
                ...
                <p className="font-regular pl-2">{info.details.first_air_date}</p>
            </h1> 
            <h1 className="flex">
                <p className="font-semibold ">Runtime:</p>
                <p className="font-regular pl-2">{info.details.episode_run_time[0]} min</p>
            </h1>
            <h1 className="flex">
       ...
       {info.recommendations.length || info.similar.length ? (<div className="bg-[#1f1e24]/60 my-5 rounded-md  mx-5 px-3">
            <h1 className="text-2xl font-semibold text-zinc-400 pt-2">Recommendations</h1>
              <HorizontalCards data={info.recommendations.length >0 ? info.recommendations : info.similar} />
       </div>):''}
       {info.details.seasons.length>0 ? (<div className="bg-[#1f1e24]/60 my-5 rounded-md   mx-5 px-3">
